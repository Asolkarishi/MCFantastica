...
public class BloodPeatBlock extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:bloodpeat")
	public static final Block block = null;
	public BloodPeatBlock(MCFantasticaElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.WET_GRASS).hardnessAndResistance(2f, 10f).lightValue(0).harvestLevel(2)
					.harvestTool(ToolType.SHOVEL));
			setRegistryName("bloodpeat");
		}
