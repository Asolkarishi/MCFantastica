...
public class CobaltOreBlockBlock extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:cobaltoreblock")
	public static final Block block = null;
	public CobaltOreBlockBlock(MCFantasticaElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cobaltoreblock");
		}
