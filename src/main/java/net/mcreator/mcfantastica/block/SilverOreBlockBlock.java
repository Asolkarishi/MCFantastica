...
public class SilverOreBlockBlock extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:silveroreblock")
	public static final Block block = null;
	public SilverOreBlockBlock(MCFantasticaElements instance) {
		super(instance, 7);
	}
