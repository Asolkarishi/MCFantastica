...
public class BloodWoodBlock extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:bloodwood")
	public static final Block block = null;
	public BloodWoodBlock(MCFantasticaElements instance) {
		super(instance, 3);
	}
