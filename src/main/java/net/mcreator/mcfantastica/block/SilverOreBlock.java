...
public class SilverOreBlock extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:silverore")
	public static final Block block = null;
	public SilverOreBlock(MCFantasticaElements instance) {
		super(instance, 6);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 5), Placement.COUNT_RANGE, new CountRangeConfig(4, 1, 1, 53)));
		}
	}
}
