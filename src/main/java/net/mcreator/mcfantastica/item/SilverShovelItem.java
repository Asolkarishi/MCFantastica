...
public class SilverShovelItem extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:silvershovel")
	public static final Item block = null;
	public SilverShovelItem(MCFantasticaElements instance) {
		super(instance, 15);
	}
