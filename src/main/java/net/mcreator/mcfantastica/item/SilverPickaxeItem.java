...
public class SilverPickaxeItem extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:silverpickaxe")
	public static final Item block = null;
	public SilverPickaxeItem(MCFantasticaElements instance) {
		super(instance, 12);
	}
