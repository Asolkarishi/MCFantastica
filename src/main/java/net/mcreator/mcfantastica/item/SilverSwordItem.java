...
public class SilverSwordItem extends MCFantasticaElements.ModElement {
	@ObjectHolder("mcfantastica:silversword")
	public static final Item block = null;
	public SilverSwordItem(MCFantasticaElements instance) {
		super(instance, 14);
	}
